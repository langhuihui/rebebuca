...
export default {
  ...
  task: {
    ...
    sshPassphrase: 'Private Key Passphrase (optional)',
    sshTestConnection: 'Test Connection',
    sshTestSuccess: 'SSH connection successful',
    sshTestFailed: 'SSH connection failed',
    sshAuthPassword: 'Password Authentication',
    sshAuthPrivateKey: 'Private Key Authentication',
    sshHostPlaceholder: 'e.g.: example.com or 192.168.1.100',
    sshUsernamePlaceholder: 'e.g.: root or ubuntu',
    sshPasswordPlaceholder: 'Enter SSH password',
    sshPrivateKeyPlaceholder: 'e.g.: ~/.ssh/id_rsa or C:\\Users\\username\\.ssh\\id_rsa',
    sshPassphrasePlaceholder: 'Enter private key passphrase if protected',
    sshRemoteExecution: 'Remote Execution',
    sshConnecting: 'Connecting to remote server...',
    sshDeployingAgent: 'Deploying remote agent...',
    sshExecuting: 'Executing command remotely...',
  },
  settings: {
    title: 'Settings',
    general: 'General',
